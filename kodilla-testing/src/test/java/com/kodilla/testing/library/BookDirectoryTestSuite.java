...
public class BookDirectoryTestSuite {
    ...
    public void testUserHave1Book(){
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(resultOf1Books);
        //When
        List theListOfBooks = bookLibrary.listBooksInHandsOf(user);
        //Then
